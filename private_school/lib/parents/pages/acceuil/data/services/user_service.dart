  ...
  Future<List<Map<String, dynamic>>> getAllUsers() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final List<dynamic> usersJson = data is List ? data : (data['data'] ?? data['users'] ?? []);
        ...
        final users = usersJson.map((json) {
          return {
            'id': json['id'] as int,
            'name': json['full_name'] as String? ?? json['name'] as String? ?? 'Utilisateur',
  ...
  Future<Map<String, dynamic>?> getCurrentUser() async {
    ...
    try {
      ...
      if (userDataRaw == null || userDataRaw.isEmpty) {
        debugPrint('⚠️ Aucune donnée utilisateur trouvée');
        return null;
      }
