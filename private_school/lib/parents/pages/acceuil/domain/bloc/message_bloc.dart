...
class MessageBloc extends Bloc<MessageEvent, MessageState> {
  ...
  Future<void> _onLoadMessages(
    ...
    try {
      ...
      emit(
        MessageError(message: 'Impossible de charger les messages', error: e),
      );
    }
  }
  ...
  Future<void> _onSendMessage(
    ...
    try {
      ...
      final finalMessages = [...currentMessages, message];
      ...
      emit(MessageError(message: 'Impossible d\'envoyer le message', error: e));
    }
  }
  ...
  Future<void> _onUpdateMessage(
    ...
    try {
      ...
      emit(currentState);
      emit(
        MessageError(message: 'Impossible de modifier le message', error: e),
      );
    }
  }
  ...
  Future<void> _onDeleteMessage(
    ...
    try {
      ...
      emit(currentState);
      emit(
        MessageError(message: 'Impossible de supprimer le message', error: e),
      );
    }
  }
  ...
  void _onSetReplyTo(SetReplyToMessageEvent event, Emitter<MessageState> emit) {
  ...
  void _onUserTyping(UserTypingEvent event, Emitter<MessageState> emit) {
    final currentState = state;
    if (currentState is MessageLoaded) {
  ...
  void _onResetMessages(ResetMessagesEvent event, Emitter<MessageState> emit) {
