                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              DateFormat('EEEE dd MMMM', 'fr_FR').format(planning.date),
                    ...
                    children: [
                      Expanded(
                        child: OutlinedButton(
                          onPressed: isLoading ? null : () => _respondToReplacement(context, false),
                          ...
                          child: Text('Refuser',
                              style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w600, color: Colors.red.shade600)),
                        ),
                      ),
                      const SizedBox(width: 12),
                      Expanded(
                        child: ElevatedButton(
                          onPressed: isLoading ? null : () => _respondToReplacement(context, true),
                          ...
                          child: isLoading
                              ...
                              : Text('Accepter', style: GoogleFonts.inter(fontSize: 16, fontWeight: FontWeight.w600)),
                        ),
                      ),
                    ],
                  ),
