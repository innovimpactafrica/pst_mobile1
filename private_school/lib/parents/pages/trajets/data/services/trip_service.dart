...
class TripService {
  ...
  /// 🆕 Get all AVAILABLE trips (trajets disponibles pour réserver)
  ...
  Future<List<TripModel>> getAllTrips() async {
    try {
      ...
      debugPrint('ℹ️ Récupère les trajets disponibles pour réservation');
      debugPrint('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
      ...
      if (response.data is List) {
        ...
        if (map.containsKey('data') && map['data'] is List) {
          ...
          debugPrint('⚠️ Keys found: ${map.keys.toList()}');
        }
      }
  ...
  /// 🆕 Get MY reservations (trajets déjà réservés par le parent)
  ...
  Future<List<TripModel>> getMyReservations() async {
    try {
      ...
      debugPrint('ℹ️ Récupère les trajets déjà réservés');
      debugPrint('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  Future<Map<String, dynamic>> reserveTrip({
    ...
    try {
      ...
      debugPrint('ℹ️ Le trajet apparaîtra maintenant dans "Mes réservations"');
      debugPrint('ℹ️ Le statut sera synchronisé avec le chauffeur/admin');
      debugPrint('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
