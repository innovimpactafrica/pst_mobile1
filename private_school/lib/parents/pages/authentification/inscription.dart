...
class _InscriptionPageState extends State<InscriptionPage> {
  ...
  int _currentPage = 0;
  // ✅ AJOUTER CES LIGNES - Contrôleurs pour les champs
...
// ✅ AJOUTER CETTE NOUVELLE MÉTHODE
  ...
  Widget _buildStep1() {
    return _buildForm([
      _buildLabeledField("Prénom et nom", "Ex: Birima Diop", _nameController),
      _buildLabeledField("Numéro de téléphone", "Ex: 77 123 45 67", _phoneController),
      _buildLabeledField("Adresse email", "Ex: bdiop@gmail.com", _emailController),
    ]);
  }
