class ApiConstants {
  ...
  static String childrenBySchool(int schoolId) =>
  ...
  static const String driverSubscriptionRenew =
      '/api/drivers/subscription/renew';
  static const String driverSubscriptionAlertes =
  ...
  static String driverTripCompleted(String id) =>
      '/api/drivers/trips/$id/completed';
  static String driverTripCanceled(String id) =>
  ...
  static String conversationMute(String id) => '/api/conversations/$id/mute';
